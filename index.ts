...
class Person {
    ...
    constructor(nombre:string, edad:number, something:(string)=>void) {
      this.name=nombre;
      this.age=edad;
...
class Developer extends Person {
  public bestLanguage(cadena2: string): void {  }

  constructor(nombre:string, edad:number, something:(string)=>void, lenguaje:(string) => void) {
    super(nombre, edad, something);
